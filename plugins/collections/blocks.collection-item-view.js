 ...
 * render: render the collection - onAdd: called when a model was added to the
...
Blocks.Handler.Collection.ItemView = Blocks.Handler.BaseElementHandler
		.extend({
			 ...
			 * collection has 0 items, renderEmpty will be called, otherwise,
			...
			/**
			 * render the collection again as the collection will represent a
			 * reset state
			 */
			onReset : function() {
			...
			/**
			 * Return a hash contain props for 'func' and 'context' depending if
			 * the a function was found as a property of the view of the default
			 * function.
			 * 
			 * @param viewNames
